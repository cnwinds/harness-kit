...
export const resolveUserVisiblePath = (config: HarnessConfig, userId: string, absolutePath: string) => {
  ...
  if (config.INSTALLED_SKILLS_ROOT && absolutePath.startsWith(config.INSTALLED_SKILLS_ROOT)) {
