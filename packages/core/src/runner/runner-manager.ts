...
import type { FileServiceLike } from '../file-service.js';
            ...
            callbacks: {
              ...
              onArtifact: async (artifact) => {
                ...
                const record = await this.fileService.recordGeneratedFile({
                  ...
                  displayName: artifact.label ?? path.basename(normalizedPath),
                  visibility: artifact.visibility === 'hidden' ? 'hidden' : 'visible',
                });
